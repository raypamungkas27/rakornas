                ...
                <div class="project-info">
                    ...
                    <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
                        <div class="d-flex align-items-center">
                            <div class="ml-2">
                                <span>Status Kuesioner Acara </span>
                                @if ($item->AcaraModel->status_kuesioner == 1)
                    ...
                    <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
                        <div class="d-flex align-items-center">
                            <div class="ml-2">
                                <span>Status Kuesioner Peserta </span>
                                @if ($item->status_kuesioner == 1)
                                    <h5 class="mb-0 pt-1 font-w50 text-info">Sudah mengisi kuesioner</h5>
                                @else
                                    <h5 class="mb-0 pt-1 font-w50 text-danger">Belum mengisi kuesioner</h5>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="ml-2">
                                ...
                                @else
                                    ...
                                    <a href="/peserta/app/kuesioner/show/{{ $item->id }}" class="btn btn-primary btn-sm" >Kuesioner</a>
                                @endif
                            </div>
                        </div>
                    </div>
