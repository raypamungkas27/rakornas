...
<div class="card">
    ...
    <div class="card-body">
        <form action="/admin/master/acara" id="tambahAcara" enctype="multipart/form-data" method="post">
            @csrf

            <div class="form-group">
                <label for="judul_acara">Judul Acara <small class="text-danger">*</small> </label>
                <input type="text" class="form-control" required id="judul_acara" name="judul_acara"
                    placeholder="Masukan Judul Acara">
            </div>
            <div class="form-group">
                <label for="tema">Tema Acara <small class="text-danger">*</small></label>
                <input type="text" class="form-control" required id="tema" name="tema" placeholder="Masukan Tema Acara">
            </div>
            <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" required id="jam_akhir" name="jam_akhir"
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" required id="kuota" name="kuota"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control harga" id="harga_zoom_umum" name="harga_zoom_umum"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control harga" id="harga_zoom_aptikom" name="harga_zoom_aptikom"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="harga_youtube_umum">Harga Youtube Umum (Sertifikat) <small
                                class="text-danger">*</small> </label>
                        <input type="text" class="form-control harga" id="harga_youtube_umum" name="harga_youtube_umum"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="harga_youtube_aptikom">harga Youtube Aptikom (Sertifikat) <small
                                class="text-danger">*</small> </label>
                        <input type="text" class="form-control harga" id="harga_youtube_aptikom" name="harga_youtube_aptikom"
            ...
            <div class="form-group">
                ...
                <div class="selectgroup selectgroup-pills">
                    <label class="selectgroup-item">
                        <input type="checkbox" name="via_zoom_sertifikat" value="1" class="selectgroup-input">
                        <span class="selectgroup-button">Zoom (sertifikat)</span>
                    </label>

                    <label class="selectgroup-item">
                        <input type="checkbox" name="via_youtube_sertifikat" value="1" class="selectgroup-input">
                        <span class="selectgroup-button">Youtube (sertifikat)</span>
                    </label>

                    <label class="selectgroup-item">
                        <input type="checkbox" name="via_zoom_gratis" value="1" class="selectgroup-input">
                        <span class="selectgroup-button">Zoom (Gratis)</span>
                    </label>

                    <label class="selectgroup-item">
                        <input type="checkbox" name="via_youtube_gratis" value="1" class="selectgroup-input">
