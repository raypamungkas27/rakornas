...
<head>
	...
	<title>Admin Rakornas 2021 | @yield('title') </title>
	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
	<link rel="icon" href="{{ asset("assets/peserta/images") }}/logoAptikom.png" type="image/x-icon"/>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="/admin/dashboard" class="logo">
					 <span style="color: white !important" >Admin Rakornas</span> 
				</a>
						...
						<li class="nav-item {{ request()->is('admin/master/*') ? 'active' : '' }}">
							...
							<div class="collapse" id="charts">
								<ul class="nav nav-collapse">
									...
									<li class="{{ request()->is('admin/master/acara') ? 'active' : '' }}">
										<a href="/admin/master/acara" >
											<span class="sub-item">Data Acara</span>
										</a>
									</li>
									...
									<li class="{{ request()->is('admin/master/validasi') ? 'active' : '' }}">
										<a href="/admin/master/validasi" >
											<span class="sub-item">Data Validasi</span>
										</a>
									</li>
